 ...
 * co_retrievals(id_a, id_b, count). Com o tempo, memórias que sempre
 * aparecem juntas criam links associativos automáticos.
 *
 * Quando recuperando sobre "Orion", automaticamente surfaça "pm2"
 * se os dois sempre aparecem juntos — sem precisar da keyword.
 */
...
export function recordCoRetrieval(ids) {
  ...
  try {
    const stmt = db.prepare(`
      INSERT INTO co_retrievals (id_a, id_b, count, last_at)
      VALUES (?, ?, 1, ?)
