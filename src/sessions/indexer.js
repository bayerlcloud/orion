...
const FACT_SIGNALS = /\b(compr|adquir|contrat|decidi|decidimos|prefir|prefiro|gosto|odeio|uso |usamos|utilizo|meu |minha |meus |minhas |novo projeto|nova vps|nova máquina|criei|lembr[ae]|na verdade|mudei|troc[ao]|vamos usar|passei a|senha|credencial|chave|token|ip |dom[ií]nio|subdom[ií]nio|e-?mail|telefone|cpf|chama-?se|chamad[ao]|se chama)\b/i
